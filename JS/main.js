...
const bann = document.getElementById("About");
bann.style.backgroundImage = `url('${RYC.imgDescription}')`;
this.document.getElementById("Description").innerHTML = `<p id="Conocenos" class="Des">${RYC.history}</p>`;
...
this.document.getElementById("Contac").innerHTML = `
  ...
  <p class="Fdescription">${RYC.description}.</p>`
  RYC.services.forEach((services) => {
